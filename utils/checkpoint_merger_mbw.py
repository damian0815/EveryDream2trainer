...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default='weighted_sum', choices=['weighted_sum', 'sigmoid', 'inv_sigmoid', 'add_diff', 'reset_and_perturb', 'NEON'], help="merging algorithm")
